                    ...
                    <div class="col-md-10 offset-md-1 col-lg-3 offset-lg-0">
                        <div class="sidebar">
                            ...
                            <div class="widget user">
                                ...
                                <!-- User Name -->
                                <h5 class="text-center">{{this.AuthUser.name}}</h5>
                            </div>
                            <!-- Dashboard Links -->
                            <div class="widget dashboard-links">
                                <ul>
                                    ...
                                    <li><a class="my-1 d-inline-block" href="">Favourite Stores <span>(3)</span></a>
                                    </li>
                                ...
                                <div class="widget personal-info">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" :value="this.AuthUser.name" class="form-control" id="first-name">
                                        </div>
                                        <!-- Last Name -->
                                        <div class="form-group">
